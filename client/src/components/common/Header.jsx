...
import MenuIcon from "../../../../server/public/assets/icons/menu-burger.svg"; // eslint-disable-line
import CloseIcon from "../../../../server/public/assets/icons/cross.svg"; // eslint-disable-line
      ...
      <nav className="nav container">
        ...
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
          ...
          {Toggle && (
            ...
            >
              <img src={CloseIcon} alt="nav close icon" />
            </button>
          )}
        </div>
        ...
        {!Toggle && (
          ...
          >
            <img src={MenuIcon} alt="nav toggle icon" />
          </button>
        )}
      </nav>
    </header>
